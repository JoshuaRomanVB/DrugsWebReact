...
const Header = () => {
    ...
    return (
        ...
        <div className="container" id="promotion-content">
            ...
            <div className="ps-block__center">
                <p className="text-design-buy">COMPRA AHORA<span className="blue-text">HASTA 45% DE DESCUENTO</span></p>
            </div><a className="ps-btn ps-btn--sm button-color" href="#">TIENDA</a>
        </div>
    </div>
 <nav>
